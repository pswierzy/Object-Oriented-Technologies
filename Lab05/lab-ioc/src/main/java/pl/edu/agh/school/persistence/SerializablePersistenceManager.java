...
public final class SerializablePersistenceManager implements IPersistenceManager{
    ...
    @Inject
    public void setTeachersStorageFileName(@Named("classes storage") String classStorageFileName) {
        this.teachersStorageFileName = classStorageFileName;
    }

    @Inject
    public void setClassStorageFileName(@Named("teachers storage") String teachersStorageFileName) {
        this.classStorageFileName = teachersStorageFileName;
    }
