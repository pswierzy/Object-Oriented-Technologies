...
public class GoogleSearchDriver {
    ...
    private static URI getGoogleSearchUri(String searchQuery) {
        var queryRequest = String.format("https://customsearch.googleapis.com/customsearch/v1?key=%s&cx=b09e01979881f4e9c&searchType=image&q=%s", Main.GOOGLE_CUSTOM_SEARCH_API_KEY, searchQuery);
